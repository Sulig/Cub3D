...
/*   Updated: 2025/01/10 20:00:58 by andmart2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printmap(t_game *gm)
{
	...
	if (end_x > gm->map->width) end_x = gm->map->width;
	if (end_y > gm->map->height) end_y = gm->map->height;
	...
	// Dibujar al jugador en el centro del minimapa
	paint_player(gm);
}
